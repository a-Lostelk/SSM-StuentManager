      ...
      <div class="row" >
        <div class="formControls col-8 col-offset-3" >
          <input id="submitBtn" type="button" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
            <input id="reset" type="reset" class="btn btn-danger radius size-L" value="&nbsp;重&nbsp;&nbsp;&nbsp;&nbsp;置&nbsp;" style="float: right;margin-right: 42px">
        </div>
      </div>
    </form>
  </div>
</div>
<div class="footer">Copyright &nbsp; sunny &nbsp;@ 宜春职业技术学院 </div>
